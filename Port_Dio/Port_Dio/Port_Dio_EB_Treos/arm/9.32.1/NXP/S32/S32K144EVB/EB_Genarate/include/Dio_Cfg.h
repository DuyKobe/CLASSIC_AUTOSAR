...
/**
* @brief          Symbolic name for the channel BTN1.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_BTN1 ((uint16)0x004cU)

/**
* @brief          Symbolic name for the channel BTN2.
*
*/


/** @violates @ref Dio_Cfg_H_REF_1 The used compilers use more than 31 chars for identifiers. */
#define  DioConf_DioChannel_BTN2 ((uint16)0x004dU)
