...
#define PORT_REGESYS_GPIO_AR_RELEASE_MINOR_VERSION_REG     2
#define PORT_REGESYS_GPIO_AR_RELEASE_REVISION_VERSION_REG  2
#define PORT_REGESYS_GPIO_SW_MAJOR_VERSION_REG             1
#define PORT_REGESYS_GPIO_SW_MINOR_VERSION_REG             0
#define PORT_REGESYS_GPIO_SW_PATCH_VERSION_REG             5
